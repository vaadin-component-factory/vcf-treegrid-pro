...
import com.vaadin.flow.component.gridpro.AbstractGridPro;
...
public class TreeGridPro<T> extends AbstractGridPro<T>
     ...
     * {@link TreeGridPro#TreeGrid(Class)}, to create a {@code TreeGrid} that
     ...
     */
    protected TreeGridPro(int pageSize,
        TreeDataCommunicatorBuilder<T> dataCommunicatorBuilder) {
     ...
     */
    public TreeGridPro(Class<T> beanType) {
      this(beanType, true);
    }
     ...
     */
    public TreeGridPro(Class<T> beanType, boolean autoCreateColumns) {
     ...
     *            uses to handle all data communication.
     */
    protected TreeGridPro(Class<T> beanType,
        TreeDataCommunicatorBuilder<T> dataCommunicatorBuilder) {
        this(beanType, dataCommunicatorBuilder, true);
    }

    private TreeGridPro(Class<T> beanType,
        TreeDataCommunicatorBuilder<T> dataCommunicatorBuilder,
     ...
     */
    public TreeGridPro(HierarchicalDataProvider<T, ?> dataProvider) {
        this();
        setDataProvider(dataProvider);
    }
       
    public static class TreeDataCommunicatorBuilder<T>
    ...
    public Registration addExpandListener(
            ComponentEventListener<ExpandEvent<T, TreeGridPro<T>>> listener) {
    ...
    public Registration addCollapseListener(
            ComponentEventListener<CollapseEvent<T, TreeGridPro<T>>> listener) {
    ...
    public <V extends Component> Column<T> addComponentHierarchyColumn(
      ...
      return addColumn(new HierarchyColumnComponentRendererPro<V,T>(
...
//    }
    ...
    protected void expand(Collection<T> items, boolean userOriginated) {
        ...
        fireEvent(new ExpandEvent<T, TreeGridPro<T>>(this, userOriginated,
                expandedItems));
    }
    ...
    protected void collapse(Collection<T> items, boolean userOriginated) {
        ...
        fireEvent(new CollapseEvent<T, TreeGridPro<T>>(this, userOriginated,
                collapsedItems));
    }
