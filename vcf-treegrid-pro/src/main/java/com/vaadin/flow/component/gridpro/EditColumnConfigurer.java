...
import com.vaadin.flow.component.gridpro.AbstractGridPro.EditColumn;
 ...
 *            the grid bean type
 */
public class EditColumnConfigurer<T> implements Serializable {
     ...
     */
    EditColumnConfigurer(EditColumn<T> column,
     ...
     */
    public EditColumnConfigurer<T> withManualRefresh() {
