 ...
 *
 */
public class AbstractGridPro<E> extends Grid<E> {
    ...
    public static class EditColumn<T> extends Column<T> {
         ...
         *            {@code null}
         */
        public EditColumn(AbstractGridPro<T> grid, String columnId,
                Renderer<T> renderer) {
     ...
     * @see EditColumnConfigurer#text(ItemUpdater)
     * @see EditColumnConfigurer#checkbox(ItemUpdater)
     * @see EditColumnConfigurer#select(ItemUpdater, List)
     * @see #removeColumn(Column)
     */
    public EditColumnConfigurer<E> addEditColumn(
     ...
     * @see #removeColumn(Column)
     */
    public <V extends Comparable<? super V>> EditColumnConfigurer<E> addEditColumn(
